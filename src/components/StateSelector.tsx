  ...
  return <div className="flex items-center justify-center gap-2">
    <button
      ...
      className={classNames({
        "px-4 py-2 rounded-lg border-2 border-red-800": true,
        "bg-red-600 text-neutral-200": pomodoro.state === PomodoroState.work
      })}
    >
      work!
    </button>
    <button
      ...
      className={classNames({
        "px-4 py-2 rounded-lg border-2 border-red-800": true,
        "bg-red-600 text-neutral-200": pomodoro.state === PomodoroState["short break"]
      })}
    >
      short break
    </button>
    <button
      ...
      className={classNames({
        "px-4 py-2 rounded-lg border-2 border-red-800": true,
        "bg-red-600 text-neutral-200": pomodoro.state === PomodoroState["long break"]
      })}
    >
      long break
    </button>
